...
export const WORK_ORDER_ORCHESTRATION_RULES = [
  {
    ...
    conditions: { newStatus: WORK_ORDER_STATUS.AwaitingQuote },
    enabled: true,
    priority: 50,
    severity: "normal",
  ...
  },
  {
    ...
    conditions: { newStatus: WORK_ORDER_STATUS.AwaitingClientApproval },
    enabled: true,
    priority: 60,
    severity: "high",
  ...
  {
    ruleKey: "work-order.approved-to-proceed.scheduling",
    lifecycle: "work-order",
    entityType: "work-order",
    trigger: {
      type: "TRANSITION_EVENT",
    ...
    conditions: { newStatus: WORK_ORDER_STATUS.ApprovedToProceed },
    enabled: true,
    priority: 70,
    severity: "high",
    description: "Flag approved work for scheduling attention.",
    actions: [
      {
        actionType: "FLAG_ENTITY",
        message: "Work order is approved to proceed and needs scheduling attention.",
      ...
      {
        actionType: "CREATE_FOLLOW_UP_TASK",
        message: "Schedule the approved work order.",
