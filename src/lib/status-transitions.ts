...
export const WORK_ORDER_TRANSITION_RULES = [
  workOrderRule("draft", "submitted", coordinatorOperationsRoles, "standard"),
  workOrderRule("draft", "cancelled", coordinatorOperationsRoles, "standard"),
  workOrderRule("submitted", "approved", managerOverrideRoles, "standard"),
  workOrderRule("submitted", "assigned", coordinatorOperationsRoles, "standard"),
  workOrderRule("submitted", "cancelled", coordinatorOperationsRoles, "standard"),
  workOrderRule("approved", "assigned", coordinatorOperationsRoles, "standard"),
  workOrderRule("approved", "cancelled", managerOverrideRoles, "override"),
  workOrderRule("assigned", "in_progress", coordinatorOperationsRoles, "standard"),
  workOrderRule("assigned", "scheduled", coordinatorOperationsRoles, "standard"),
  workOrderRule("assigned", "cancelled", managerOverrideRoles, "override"),
  workOrderRule("scheduled", "in_progress", coordinatorOperationsRoles, "standard"),
  workOrderRule("scheduled", "cancelled", managerOverrideRoles, "override"),
  workOrderRule(
    "in_progress",
    "waiting_on_contractor",
    coordinatorOperationsRoles,
    "standard",
  ),
  workOrderRule(
    "in_progress",
  ...
  workOrderRule("in_progress", "quoted", coordinatorOperationsRoles, "standard"),
  workOrderRule(
    "waiting_on_contractor",
    "quoted",
    coordinatorOperationsRoles,
  ...
  workOrderRule("quoted", "scheduled", managerOverrideRoles, "quote_approval"),
  workOrderRule("quoted", "in_progress", managerOverrideRoles, "reopen"),
  workOrderRule("quoted", "cancelled", managerOverrideRoles, "override"),
  workOrderRule(
    "in_progress",
    "completed",
    coordinatorOperationsRoles,
  ...
  workOrderRule("completed", "in_progress", managerOverrideRoles, "reopen"),
  workOrderRule("completed", "invoiced", financeRoles, "invoice_issuance"),
  workOrderRule("invoiced", "closed", financeRoles, "payment_completion"),
  workOrderRule("invoiced", "completed", ownerOverrideRoles, "override"),
  workOrderRule("closed", "invoiced", ownerOverrideRoles, "override"),
