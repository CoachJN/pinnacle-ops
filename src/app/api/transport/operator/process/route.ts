...
export async function POST(request: NextRequest) {
  return withApiRoute(request, "/api/transport/operator/process", async (requestContext) => {
...
function parseProcessInput(
  ...
  return {
    workerId: optionalString(body.workerId, "workerId") ?? `transport-operator:${requestId}`,
