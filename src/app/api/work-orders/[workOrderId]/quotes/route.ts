...
export async function GET(_request: NextRequest, { params }: RouteContext) {
  return withApiRoute(
    ...
    const quotes = await context.repositories.quotes.listByWorkOrderId(workOrderId);
...
export async function POST(request: NextRequest, { params }: RouteContext) {
  return withApiRoute(
    ...
    const existingQuotes = await context.repositories.quotes.listByWorkOrderId(workOrderId);
