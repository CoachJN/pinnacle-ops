...
export async function POST(request: NextRequest) {
  return withApiRoute(request, "/api/delivery/operator/process", async (requestContext) => {
...
function parseProcessInput(
  ...
  return {
    workerId: optionalString(body.workerId, "workerId") ?? `delivery-operator:${requestId}`,
