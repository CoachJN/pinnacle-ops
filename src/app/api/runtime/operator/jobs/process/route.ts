...
export async function POST(request: NextRequest) {
  return withApiRoute(request, "/api/runtime/operator/jobs/process", async (requestContext) => {
    ...
    const input = parseProcessJobsInput(body, requestContext.requestId);
...
function parseProcessJobsInput(
  ...
  return {
    workerId: optionalString(body.workerId, "workerId") ?? `operator:${requestId}`,
    ...
    jobTypes: optionalStringArray(body.jobTypes, "jobTypes"),
